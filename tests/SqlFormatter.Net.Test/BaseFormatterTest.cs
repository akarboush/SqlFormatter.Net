...
namespace SqlFormatter.Net.Test
{
    public abstract class BaseFormatterTest
    {
        ...
        /// </summary>
        protected void BehavesLikeSqlFormatter(Formatter formatter)
        {
...
FROM
  tbl2;";
        ...
        /// </summary>
        protected void BehavesLikeMariaDbFormatter(Formatter formatter)
        {
  ...
  @foo := (
    ...
    FROM
      tbl
        ...
        /// </summary>
        protected void SupportsComments(Formatter formatter)
        {
...
@"SELECT
  ...
  /*Comment";
        ...
        /// </summary>
        protected void SupportsConfigOptions(Formatter formatter)
        {
...
FROM
    Table1;";
            ...
            string output = formatter.Format(input, new FormatOptions(indent: Indent.FourSpaces, uppercase: false));
            Assert.Equal(expectedResult, output);
...
FROM
  bar;";
            ...
            output = formatter.Format(input, new FormatOptions(indent: Indent.TwoSpaces, uppercase: false, linesBetweenQueries: 2));
            Assert.Equal(expectedResult, output);
...
WHERE
  ...
  AND colb = 3";
            ...
            output = formatter.Format(input, new FormatOptions(indent: Indent.TwoSpaces, uppercase: true));
            Assert.Equal(expectedResult, output);
        }
        ...
        /// </summary>
        protected void SupportsOperators(Formatter formatter, params string[] operators)
        {
        ...
        /// </summary>
        protected void SupportsCase(Formatter formatter)
        {
...
@"CASE
  ...
  ELSE 4
END;";
            string output = formatter.Format(input, new FormatOptions(indent: Indent.TwoSpaces, uppercase: true));
            Assert.Equal(expectedResult, output);
        }
        ...
        /// </summary>
        protected void SupportsCreateTable(Formatter formatter)
        {
...
@"CREATE TABLE items (
  ...
  doggie INT NOT NULL
        ...
        /// </summary>
        protected void SupportsAlterTable(Formatter formatter)
        {
...
ALTER COLUMN
  supplier_name VARCHAR(100) NOT NULL;";
        ...
        /// </summary>
        protected void SupportsAlterTableModify(Formatter formatter)
        {
...
MODIFY
  supplier_name char(100) NOT NULL;";
        ...
        /// </summary>
        protected void SupportsStrings(Formatter formatter, params string[] stringTypes)
        {
            string input;
            string expectedResult;
        ...
        /// </summary>
        protected void SupportsBetween(Formatter formatter)
        {
        ...
        /// </summary>
        protected void SupportsSchema(Formatter formatter)
        {
...
@"SET SCHEMA
  schema1;";
        ...
        /// </summary>
        protected void SupportsJoin(Formatter formatter, string[]? without = null, string[]? additionally = null)
        {
...
FROM
  ...
  {join} orders ON customers.customer_id = orders.customer_id;";
        ...
        protected void AssertFormat(Formatter formatter, string input, string expectedOutput)
        {
            string output = formatter.Format(input);
