...
{
    public sealed class RedshiftFormatter : Formatter
    {
        public RedshiftFormatter(FormatOptions? formatOptions = default) : base(formatOptions)
        {
        }
        ...
        private string[] ReservedTopLevelWordsNoIndent => Array.Empty<string>();
